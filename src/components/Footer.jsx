    ...
    <footer className="bg-brand-black text-white">
      ...
      <div className="container-xl pt-16 pb-10 flex flex-col items-center text-center gap-5">
        ...
        <div>
          <p className="font-bold text-white text-base">
            Kesintisiz Enerji İçin Güvenilir Çözüm Ortağınız
          </p>
          <p className="text-gray-400 text-sm mt-1">
            Ücretsiz Teklif İçin Bugün Bizi Arayın
          </p>
        </div>
      ...
      <div className="container-xl pb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link
            to="/iletisim"
            className="flex items-center gap-2.5 bg-brand-orange px-4 py-3 rounded-lg hover:brightness-95 transition-all"
          >
            <svg
            ...
            <div>
              <p className="text-brand-black text-[10px] font-semibold mb-0.5">
                Basit &amp; Ücretsiz
              </p>
              <p className="text-brand-black text-sm font-extrabold leading-tight">
                Teklif Al
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-brand-black text-xs font-extrabold leading-tight break-all">
      ...
      <div className="border-t border-white/10">
        <div className="container-xl py-6 flex flex-col md:flex-row items-center justify-between gap-5 flex-wrap">
          <div className="flex items-center gap-2.5 text-sm text-gray-400">
            ...
            NİLTİM – Üçevler Mah. Ersan Sk. 8A Kat:1A, İbrahim Yazıcı Plaza 2,
            Nilüfer/Bursa
          </div>
