...
const areas = [
  { label: 'Bağcılar', href: '/hizmet-bolgesi' },
  { label: 'Güngören', href: '/hizmet-bolgesi' },
  { label: 'Bahçelievler', href: '/hizmet-bolgesi' },
  { label: 'Küçükçekmece', href: '/hizmet-bolgesi' },
]
    ...
    <footer className="bg-brand-black text-white">
      ...
      <div className="container-xl pt-16 pb-10 flex flex-col items-center text-center gap-5">
        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-lg font-extrabold tracking-wide text-white uppercase">
            Kanmaz <span className="text-brand-orange">Elektrik</span>
          </span>
        </Link>
        ...
        {/* Trust lines */}
        <div>
          <p className="font-bold text-white text-base">1000'den Fazla Kişi Tarafından Güvenildi</p>
      ...
      <div className="container-xl pb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link
            to="/iletisim"
            className="flex items-center gap-5 bg-brand-orange px-7 py-6 rounded-2xl hover:brightness-95 transition-all group"
          >
          ...
          <a
            ...
            className="flex items-center gap-5 bg-brand-orange px-7 py-6 rounded-2xl hover:brightness-95 transition-all"
          >
            <svg className="w-8 h-8 text-brand-black shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-brand-black text-xl font-extrabold leading-tight">(212) 345 67 89</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              ...
              <p className="text-brand-black text-xl font-extrabold leading-tight break-all">info@kanmazelektrik.com</p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-xl py-6 flex flex-col md:flex-row items-center justify-between gap-5 flex-wrap">
          ...
          <div className="flex items-center gap-2.5 text-sm text-gray-400">
            ...
            Adres: Bağcılar, İstanbul, Türkiye
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="container-xl py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-500">
            {new Date().getFullYear()} © KanmazElektrik. Tüm hakları saklıdır.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Yelp */}
            <a href="https://yelp.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.16 12.73l-4.703 1.14c-.847.205-1.593-.642-1.246-1.452l1.9-4.44c.31-.73 1.275-.842 1.77-.208l2.802 3.3c.496.583.218 1.453-.523 1.66zm-8.54 5.44l-.584 4.82c-.1.844-1.05 1.237-1.683.706L5.91 20.34c-.634-.531-.494-1.522.254-1.862l4.42-1.963c.81-.359 1.713.268 1.636 1.155zm7.23-10.03l-2.802-3.3c-.496-.583-1.46-.47-1.77.208l-1.9 4.44c-.347.81.4 1.657 1.246 1.452l4.703-1.14c.74-.207 1.02-1.077.523-1.66zM10.31 11.62l-4.823-.7c-.866-.125-1.372-1.04-.984-1.826l2.033-4.118c.388-.786 1.448-.85 1.93-.12l2.79 4.818c.51.88-.086 1.99-1.046 1.946h.1zm-5.11 2.19c-.41-.79-.032-1.762.826-1.874l4.836-.611c.964-.121 1.617.94 1.148 1.8l-2.51 4.664c-.42.78-1.478.815-1.94.07L5.2 13.81z"/>
              </svg>
            </a>
            {/* Facebook */}
